...
- Slides: [Preprocessing](assets/2_MSqRob_data_analysisI.pdf),   <!-- + text + --> [Results of Preprocessing](assets/2_MSqRob_data_analysisIb.pdf)
...
- Slides: <!-- + text + --> [Statistical Inference](assets/2_MSqRob_data_analysisII.pdf)
